...
// projects.json is generated by generate-projects.mjs from real GitHub
// contributor stats — re-run that script to refresh these numbers.
const projects = projectsData as Project[];

// GitHub logins → real display names, for rendering collaborators nicely.
// Add teammates' logins here as you collaborate on more repos.
const COLLABORATOR_NAMES: Record<string, string> = {
  "mahnoornaeembaig-sketch": "Mahnoor Naeem",
  "raimaahh-commits": "Raimah" 
};

function displayName(login: string): string {
  return COLLABORATOR_NAMES[login] ?? login;
}
            ...
            {projects.map((p) => (
              ...
              >
                ...
                <div>
                  ...
                  <ProgressBar value={p.contribution} label="Based on lines changed per contributor" />
